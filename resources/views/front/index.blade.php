...
<link href="{{ asset('assets/https://fonts.googleapis.com/css?family=Roboto:100,300,400,900') }}" rel="stylesheet"> 
</head>
<body id="mobile_wrap">
            ...
            <div class="page-content">
			    ...
			    <div class="navbarpages">
                 ...
                 <div class="swiper-container slidertoolbar swiper-init" data-effect="slide" data-parallax="true" data-pagination=".swiper-pagination"  data-next-button=".swiper-button-next" data-prev-button=".swiper-button-prev">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide" style="background-image:url(images/SL1.jpg);">
			 ...
			 <div class="slider-caption">
				  ...
				  <p data-swiper-parallax="-30%">Accédez à des contacts exclusifs et des formations enrichissantes. Gagnez 50 % sur chaque parrainage !</p>
                      ...
                      <div class="swiper-slide" style="background-image:url(images/SL2.jpg);">
			<div class="slider_trans">		  
				<div class="slider-caption">
				<span class="subtitle" data-swiper-parallax="-60%">BIENVENUE SUR BLIX</span>
				...
				<p data-swiper-parallax="-30%">Invitez vos amis et touchez des commissions sur 5 générations !</p>
                      ...
                      <div class="swiper-slide" style="background-image:url(images/SL3.jpg);">
			<div class="slider_trans">		  
				<div class="slider-caption">
				<span class="subtitle" data-swiper-parallax="-60%">BIENVENUE SUR BLIX</span>
		 ...
		 <div class="swiper-container-toolbar swiper-toolbar swiper-init" data-effect="slide" data-slides-per-view="1" data-slides-per-group="1" data-space-between="0" data-pagination=".swiper-pagination-toolbar">
			...
			<div class="">
			  <div class="swiper-slide toolbar-icon">
				<a href="{{ asset('assets/#') }}" data-popup=".popup-signup" class="open-popup"><img src="{{ asset('assets/images/icons/blue/users.png') }}" alt="" title="" /><span>INSCRIPTION</span></a>
			        <a href="{{ asset('assets/#') }}" data-popup=".popup-login" class="open-popup"><img src="{{ asset('assets/images/icons/blue/user.png') }}" alt="" title="" /><span>CONNEXION</span></a>
				<a href="{{ asset('assets/#') }}" data-popup=".popup-plan" class="open-popup"><img src="{{ asset('assets/images/icons/blue/more.png') }}" alt="" title="" /><span>PACK DISPONIBLE</span></a>
				<a href="{{ asset('assets/#') }}" data-popup=".popup-temoignage" class="open-popup"><img src="{{ asset('assets/images/icons/blue/temoignage.png') }}" alt="" title="" /><span>TÉMOIGNAGE</span></a>
				<a href="{{ asset('assets/#') }}" data-popup=".popup-faq" class="open-popup"><img src="{{ asset('assets/images/icons/blue/features.png') }}" alt="" title="" /><span>FAQ</span></a>
				<a href="{{ asset('assets/#') }}" data-popup=".popup-contact" class="open-popup"><img src="{{ asset('assets/images/icons/blue/contact.png') }}" alt="" title="" /><span>CONTACT</span></a>
				<a href="{{ asset('assets/blog.html') }}"><img src="{{ asset('assets/images/icons/blue/contact.png') }}" alt="" title="" /><span>CONTACT</span></a>
				<a href="{{ asset('assets/accueil_dashboard.html') }}"><img src="{{ asset('assets/images/icons/blue/contact.png') }}" alt="" title="" /><span>CONTACT</span></a>
			  </div> 
        ...
        <div class="content-block">
            ...
            <div class="loginform">
                <form id="LoginForm" method="post">
                    ...
                    <div class="forgot_pass"><a href="{{ asset('assets/#') }}" data-popup=".popup-forgot" class="open-popup">Mot de passe oublié?</a></div>
                    <input type="submit" name="submit" class="form_submit" id="submitlogin" value="SE CONNECTER" />
                </form>
                <div class="signup_bottom">
                    <p>Vous n'avez pas de compte ?</p>
                    <a href="{{ asset('assets/#') }}" data-popup=".popup-signup" class="open-popup">S'INSCRIRE</a>
                </div>
            </div>
            <div class="close_popup_button">
                <a href="{{ asset('assets/#') }}" class="close-popup"><img src="{{ asset('assets/images/icons/black/menu_close.png') }}" alt="" title="" /></a>
            </div>
        </div>
    </div>
            ...
            <h4>NOS CONTACTS</h4>
              ...
              <div class="conteneur-coordonnees">
                  <div class="carte-coordonnee">
                      <div ><img src="{{ asset('assets/images/icons/blue/contact.png') }}" alt="" title="" /></div>
                  ...
                  <div class="carte-coordonnee">
                      <div><img src="{{ asset('assets/images/icons/blue/phone.png') }}" alt="" title="" /></div>
    ...
    <script src="{{ asset('assets/https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/intlTelInput.min.js') }}"></script>
    <script>
