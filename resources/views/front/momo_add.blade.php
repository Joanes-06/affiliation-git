...
@section('content')
    <div class="pp-container">
        <div class="pp-header">
            <h1>Ajouter un Numéro Mobile Money</h1>
        </div>
        
        <div class="pp-content">
            <form method="POST" action="{{ route('momo.store') }}">
                @csrf

                <!-- Champ Numéro Mobile Money -->
                <div class="pp-form-group">
                    <label class="pp-label" for="momo">Numéro Mobile Money</label>
                    <input type="text" id="momo" name="momo" class="pp-input" placeholder="Votre numéro Mobile Money" required>
                    @error('momo')
